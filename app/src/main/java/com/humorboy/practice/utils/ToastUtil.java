package com.humorboy.practice.utils;
...
public final class ToastUtil {
    ...
    public static void makeText(Context context, String msg) {
        if (DemoApplication.currentActivityName.equals(context.getClass().getName())) {
            if (toast == null) {
    ...
    public static void makeTextError(Context context) {
        makeText(context, Constant.ERROR_MESSAGE);
    }
    ...
    public static void makeTextErrorLong(Context context) {
        makeTextLong(context, Constant.ERROR_MESSAGE);
    }
