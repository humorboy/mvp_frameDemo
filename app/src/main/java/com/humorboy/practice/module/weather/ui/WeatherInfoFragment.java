...
import com.humorboy.practice.module.news.ui.NewsDetailActivity;
 ...
 * UpdateDate: <p>
 */
@ActivityFragmentInject(contentViewId = R.layout.fragment_weather_info,
        handleRefreshLayout = true)
public class WeatherInfoFragment extends BaseFragment<INewsListPresenter> implements INewsListView {
