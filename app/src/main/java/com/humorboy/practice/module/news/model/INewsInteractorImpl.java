...
import com.humorboy.practice.db.NewsChannelTableDao;
    ...
    public Subscription operateChannelDb(final RequestCallback<List<NewsChannelTable>> callback) {
        ...
        return Observable.create(new Observable.OnSubscribe<List<NewsChannelTable>>() {
            ...
            public void call(Subscriber<? super List<NewsChannelTable>> subscriber) {
                ...
                final NewsChannelTableDao dao = ((DemoApplication) DemoApplication.getContext()).getDaoSession()
                        .getNewsChannelTableDao();
                KLog.e("初始化了数据库了吗？ " + SpUtil.readBoolean("initDb"));
                if (!SpUtil.readBoolean("initDb")) {

                    List<String> channelName = Arrays.asList(DemoApplication.getContext().getResources()
                            .getStringArray(R.array.news_channel));

                    List<String> channelId = Arrays.asList(DemoApplication.getContext().getResources()
