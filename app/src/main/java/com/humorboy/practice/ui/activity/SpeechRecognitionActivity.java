...
public class SpeechRecognitionActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initViews(Bundle bundle) {
        ...
        speech_synthetic = (TextView) findViewById(R.id.speech_synthetic);
        speech_synthetic.setOnClickListener(this);
...
//                boolean isShowDialog = mSharedPreferences.getBoolean(getString(R.string.pref_key_iat_show), false);
                ...
                break;
            case R.id.speech_synthetic:
                String text = ((EditText) findViewById(R.id.result_text)).getText().toString();
                // 设置参数
                setSyntheticParam();
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            if( mTranslateEnable ){
                ...
                result_text.setSelection(result_text.length());
            }
    ...
    private void showTip(final String str)
    {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ToastUtil.makeText(SpeechRecognitionActivity.this,str);
            }
        });
    }
     ...
     * @return
     */
    private void setSyntheticParam(){
        // 清空参数
